<?php 
include "koneksi.php";
$tampil = mysqli_query($koneksi, "SELECT * FROM tbl_pengaduan JOIN tbl_masyarakat ON tbl_pengaduan.nik = tbl_masyarakat.nik WHERE status = 'selesai'");
 ?>
...
<head>
  ...
  <title>Cetak Pengaduan Selesai</title>
                ...
                <table class="table">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td class="text-center"><span class="label label-danger"><?php echo $data ['status']; ?></span></td>
                    </tr>
